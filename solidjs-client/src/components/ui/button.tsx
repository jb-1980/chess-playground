...
const iconButtonVariants = cva(
  "inline-flex items-center justify-center rounded-full focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none",
  {
    variants: {
      variant: {
        ...
        outlined:
          "bg-transparent border border-current text-blue-600 hover:bg-blue-50",
...
type IconButtonProps<T extends ValidComponent = "button"> = ButtonRootProps<T> &
