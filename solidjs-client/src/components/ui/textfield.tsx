...
import type { Component, ValidComponent, VoidProps } from "solid-js"
...
export const TextInput = <T extends ValidComponent = "input">(
...
type TextFieldProps = {
  ...
  descriptionProps?: textFieldDescriptionProps
  errorMessageProps?: textFieldErrorMessageProps
}
  ...
  return (
    <TextFieldRoot>
      ...
      <TextInput
        ...
        {...props.inputProps}
      />
      <TextFieldDescription {...props.descriptionProps}>
        {props.description}
      </TextFieldDescription>
      <TextFieldErrorMessage {...props.errorMessageProps}>
        {props.errorMessage}
